...
{{
  ...
  "operations": [
    {{
      "type": "UPDATE",
      "bullet_id": "пд-00015",
      "content": "Справка о наличии счёта. Триггеры: 'справка о счёте', 'подтверждение счёта'. Не путать с выпиской по счёту (документ 1)."
    }},
    {{
      "type": "ADD",
      "section": "Инструкции",
      "content": "Если клиент спрашивает 'где посмотреть' или 'как проверить статус' ранее заказанного документа — это FAQ, не заказ нового документа."
    }}
  ]
}}
